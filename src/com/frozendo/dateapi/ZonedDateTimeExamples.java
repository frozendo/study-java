...
public class ZonedDateTimeExamples {
    ...
    private void zonedGetOptions(ZonedDateTime parisTime) {
    ...
    private void setZonedNewValues(ZonedDateTime parisTime) {
    ...
    private void plusValue(ZonedDateTime parisTime) {
    ...
    private void minusValue(ZonedDateTime parisTime) {
